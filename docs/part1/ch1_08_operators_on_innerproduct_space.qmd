...
::: {#exr-adjoint_matrix}
정규직교기저에서 정의된 $\boldsymbol{A}\in \mathcal{M}_{m \times n}(\mathbb{F})$, $\boldsymbol{v}\in\mathcal{M}_{m \times 1}(\mathbb{F})$, $\boldsymbol{u}\in \mathcal{M}_{n \times 1}(\mathbb{F})$ 에 대해 $\langle \boldsymbol{Au},\, \boldsymbol{v} \rangle = \langle \boldsymbol{u},\, \boldsymbol{A}^\ast \boldsymbol{v} \rangle$ 임을 보여라.
:::

::: {.proof}

$\mathcal{M}_{n \times n}(\mathbb{F})$ 의 정규직교기저 $\{\boldsymbol{e}_i\}$ 와 $\mathcal{M}_{m \times 1}(\mathbb{F})$ 의 정규직교기저 $\{\boldsymbol{f}_j\}$ 를 생각하자. $\boldsymbol{u}=\sum_i u_i \boldsymbol{e}_i$, $\boldsymbol{v}= \sum_j v_j \boldsymbol{f}_j$ 라고 하면,
$$
\begin{aligned}
...
&\iff \forall\boldsymbol{u}\in \mathcal{M}_{n\times 1}(\mathbb{F}),\, \langle \boldsymbol{u},\boldsymbol{A}^\ast\boldsymbol{v}\rangle = 0 \\
&\iff \forall\boldsymbol{u}\in \mathcal{M}_{n \times 1}(\mathbb{F}), \langle \boldsymbol{Au},\boldsymbol{v}\rangle = 0 \\
...
&emsp; ($4$) 모든 $\boldsymbol{u}\in \mathcal{M}_{n \times 1}(\mathbb{F})$ 에 대해 $\langle \boldsymbol{Au},\,\boldsymbol{u}\rangle =0$ 이면 $\boldsymbol{A}=0$ 이다.
...
($2$) 고유벡터 $\boldsymbol{u}\in \mathcal{M}_{m \times 1}(\mathbb{F})$ 에 대한 고유값을 $\lambda$ 라 하자. 
...
&emsp; ($1$) 임의의 $\boldsymbol{u}\in \mathcal{M}_{n \times 1}(\mathbb{C})$ 에 대해 $\langle \boldsymbol{Au},\, \boldsymbol{u}\rangle$ 은 실수이다.
...
::: {.callout-note appearance="simple" icon="false"}
::: {#def-isometry}
행렬 $\boldsymbol{S} \in \mathcal{M}_{n \times n}(\mathbb{F})$ 이 임의의 $\boldsymbol{v} \in \mathcal{M}_{n \times 1}(\mathbb{F})$ 에 대해
...
이다. 임의의 $\boldsymbol{u}\in \mathcal{M}_{n \times 1}(\mathbb{F})$ 에 대해 $\boldsymbol{S}^\ast \boldsymbol{Su} =  \boldsymbol{u}$ 이므로 $\boldsymbol{S}^\ast \boldsymbol{S}=\boldsymbol{I}$ 이다. 즉 $\boldsymbol{S}^\ast = \boldsymbol{S}^{-1}$ 이다. 
