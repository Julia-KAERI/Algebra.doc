...
### 정규 연산자와 행렬 {#sec-normal_operator}
...
::: {#prp-part1_properties_of_normal_operator}
...
전체적으로 @thm-kernel_image_of_adjoint_operator 를 참고하라.

($a$) @prp-condition_of_normal_matrix
...
::: {.proof}
$L-cI$ 가 정규연산자이므로 @prp-condition_of_normal_matrix 로부터 $0 = \|(L-cI)v\| = \|(L-cI)^\ast v\|$. $\square$ 
...
::: {#thm-part1_normal_operator_and_two_hermite_operator}
...
@prp-condition_of_normal_matrix ... to be done
