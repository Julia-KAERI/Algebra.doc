...
### 준동형사상 {#sec-MA_group_homomorphsm}
...
군 $G,\,G'$ 에서 정의된 함수 $\varphi :G \to G'$ 이 모든 $a,\,b\in G$ 에 대해
...
$G$ 에서 $G'$ 으로의 준 동형사상의 집합을 $\text{Hom}\, (G,G')$ 이라고 표기한다. 자기 자신으로의 준동형사상일 경우는 $\text{Hom}\, (G)$ 라고 한다.
