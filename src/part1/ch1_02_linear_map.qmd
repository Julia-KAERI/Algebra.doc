...
### Rank-nullity 정리 {#sec-part1_rank_nullity_theorem}
...
### 동형사상과 동형 {#sec-part1_isomorphism_of_linear_map}
...
### 선형사상공간의 차원 {#sec-part1_dimension_of_linear_map_space}
...
::: {#thm-part1_isomorphic_linear_map}
...
$U$ 가 $n$ 차원 $\mathbb{F}$-벡터공간이며 $\mathcal{B}_1 = (u_1,\ldots,u_n)$ 이 $U$ 의 기저라고 하자. $P\in \mathcal{L}(U)$ 가 가역이면 @cor-basis_transformation 에서 보았듯이 $\mathcal{B}_2= (P(u_1),\ldots, P(u_n) )$ 도 $U$ 의 기저이다. $v_i = T(u_i)$ 라고 할 때 $P$ 가 다음과 같이 정의된다고 하자.
