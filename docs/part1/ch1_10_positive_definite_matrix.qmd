...
복소수 $z=x+iy,\,x,\,y\in \mathbb{C}$ 는 $z=re^{i\theta},\, r=\sqrt{x^2+y^2},\, \theta = \tan^{-1}(y/x)$ 로 표현 할 수 있다. 어떤 행렬은 이와 비슷하게 유니타리 행렬과 non-negative 행렬의 곱으로 표현할 수 있으며 매우 유용하다. 여기에 대해 알아보기로 하자.
