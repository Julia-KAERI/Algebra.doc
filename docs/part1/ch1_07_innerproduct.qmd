...
이다. 이제 $v=\sum_{i=1}^n a_i u_i$ 라면 삼각부등식을 이용하여,

$$
{\|v\|_1}^2 = {\left\|\sum_{i=1}^n a_i u_i \right\|_1}^2 \le \left(\sum_{i=1}^n \|a_i u_i\|_1\right)^2 \le \left( \sum_{i=1}^n M |a_i|^2\right)^2 = M^2{\|v\|_2}^2
$$
