...
[생성된 부분공간](ch1_01_vectorspace.qmd#sec-generated_subspace) 에서 다뤘던 $\langle U \rangle$ 를 생각하자. 우리는 다음을 보일 수 있다.
...
$u\in \text{im}(P)$ 이면 $P(v)=u$ 인 $v\in V$ 가 존재하며, $P^2v = Pu = u$ 이므로 $\text{im}(P)$ 는 $P$ 불변 부분 공간이다.
