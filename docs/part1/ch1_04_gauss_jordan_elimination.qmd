...
이다. 그러나 무한개의 가역연산자의 경우를 생각하자. 항등연산자 $I$ 에 대해 $T_i = \dfrac{1}{2}I$, $i=1,\,2,\ldots$ 라면 $(T_1 \circ \cdots)(u)=0$ 이다. 즉 유한개의 가역연산의 합성은 가역연산이지만 무한개의 가역연산은 가역연산이라는 것을 보장 할 수 없다.   
