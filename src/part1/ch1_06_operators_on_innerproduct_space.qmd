...
Projection $P\in \mathcal{L}(V)$ 에 대해 $P=P|_U$ 인 $U\le V$ 가 존재할 필요충분조건은 $P$ 가 에르미트 행렬임을 보여라.
...
$P=P|_U$ 인 $U\le V$ 가 존재한다고 하자. $v_1,\,v_2\in V$ 에 대해 $v_1=u_1+w_1,\,v_2=u_2+w_2$ 인 $u_1,\,u_2\in U,\, w_1,\,w_2\in U^\perp$ 가 유일하게 존재한다.
...
이제 $P$ 가 에르미트 행렬이며 $U=\text{im}(P)$ 라고 하면 $P=P|_U$ 이다.
