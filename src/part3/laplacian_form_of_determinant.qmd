...
$$ {#eq-laplace_expansion_for_column}
...
::: {#lem-laplace_expansion_and_k_laternating_form_0}
...
::: {#lem-laplace_expansion_and_k_laternating_form_1}
...
::: {#lem-laplace_expansion_and_k_laternating_form_2}
...
@def-minor_expansion 의 @eq-laplace_expansion_for_row 와 @eq-laplace_expansion_for_column 은 모두 행렬식의 정의와 같다.
:::

::: {.proof}

@lem-laplace_expansion_and_k_laternating_form_1 과 @lem-laplace_expansion_and_k_laternating_form_2 에 의해 $D_i(\boldsymbol{A})$ 는 행렬식이다. 따라서 $D_i(\boldsymbol{A})=D_i(\boldsymbol{A}^T)$ 와 같다. 그런데 @lem-laplace_expansion_and_k_laternating_form_0 에 의해 $D_i(\boldsymbol{A}^T)=D^i(\boldsymbol{A}^T)$ 이다. $\square$

:::

</br>

::: {#exr-determinant_of_cartan_matrix}
