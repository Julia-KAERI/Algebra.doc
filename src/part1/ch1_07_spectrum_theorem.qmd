...
### 복소수체($\mathbb{C}$) 에서 정의된 행렬에 대한 스펙트럼 정리 {#sec-LA_spectral_theorem_on_complexe_field}
...
### 실수체에서의 스펙트럼 정리를 위해 미리 알아야 할 것들 {#sec-LA_prerequisite_for_spectral_theorem_on_real_field}
...
### 실수체에서 정의된 행렬에 대한 스펙트럼 정리 {#sec-LA_spectral_theorem_on_real_field}
